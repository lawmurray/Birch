 ...
 */
class DelayGaussianLogGaussian(μ_0:DelayGaussian, σ2:Real) <
...
function DelayGaussianLogGaussian(μ_0:DelayGaussian, σ2:Real) ->
    DelayGaussianLogGaussian {
  m:DelayGaussianLogGaussian(μ_0, σ2);
  return m;
}
