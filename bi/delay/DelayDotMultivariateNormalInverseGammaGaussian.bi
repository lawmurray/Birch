...
final class DelayDotMultivariateNormalInverseGammaGaussian(future:Real?,
  ...
  function simulate() -> Real {
    return simulate_dot_multivariate_normal_inverse_gamma_multivariate_gaussian(
        a, solve(μ!.Λ, μ!.ν), c, μ!.Λ, μ!.σ2!.α, μ!.σ2!.β);
  }
  
  function logpdf(x:Real) -> Real {
    return logpdf_dot_multivariate_normal_inverse_gamma_multivariate_gaussian(
        x, a, solve(μ!.Λ, μ!.ν), c, μ!.Λ, μ!.σ2!.α, μ!.σ2!.β);
  }
  ...
  function pdf(x:Real) -> Real {
    return pdf_dot_multivariate_normal_inverse_gamma_multivariate_gaussian(
        x, a, solve(μ!.Λ, μ!.ν), c, μ!.Λ, μ!.σ2!.α, μ!.σ2!.β);
  }

  function cdf(x:Real) -> Real {
    return cdf_dot_multivariate_normal_inverse_gamma_multivariate_gaussian(
        x, a, solve(μ!.Λ, μ!.ν), c, μ!.Λ, μ!.σ2!.α, μ!.σ2!.β);
  }
