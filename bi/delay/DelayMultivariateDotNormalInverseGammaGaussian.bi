...
class DelayMultivariateDotNormalInverseGammaGaussian(x:Random<Real>&,
  ...
  function simulate() -> Real {
    return simulate_multivariate_dot_normal_inverse_gamma_gaussian(a, μ!.μ, c, μ!.Λ, μ!.σ2.α, μ!.σ2.β);
  }
  
  function observe(x:Real) -> Real {
    return observe_multivariate_dot_normal_inverse_gamma_gaussian(x, a, μ!.μ, c, μ!.Λ, μ!.σ2.α, μ!.σ2.β);
  }

  function condition(x:Real) {
    (μ!.μ, μ!.Λ, μ!.σ2.α, μ!.σ2.β) <- update_multivariate_dot_normal_inverse_gamma_gaussian(x, a, μ!.μ, c, μ!.Λ, μ!.σ2.α, μ!.σ2.β);
  }

  function pdf(x:Real) -> Real {
    return pdf_multivariate_dot_normal_inverse_gamma_gaussian(x, a, μ!.μ, c, μ!.Λ, μ!.σ2.α, μ!.σ2.β);
  }
}
