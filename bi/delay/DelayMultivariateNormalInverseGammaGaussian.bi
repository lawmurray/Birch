...
final class DelayMultivariateNormalInverseGammaGaussian(future:Real[_]?,
  ...
  function observe(x:Real[_]) -> Real {
    return observe_multivariate_normal_inverse_gamma_gaussian(x,
        solve(μ!.Λ, μ!.ν), μ!.Λ, μ!.σ2!.α, μ!.σ2!.β);
  }

  function update(x:Real[_]) {
    (μ!.ν, μ!.Λ, μ!.γ, μ!.σ2!.α, μ!.σ2!.β) <- update_multivariate_normal_inverse_gamma_gaussian(
        x, μ!.ν, μ!.Λ, μ!.γ, μ!.σ2!.α, μ!.σ2!.β);
  }

  function downdate(x:Real[_]) {
    (μ!.ν, μ!.Λ, μ!.γ, μ!.σ2!.α, μ!.σ2!.β) <- downdate_multivariate_normal_inverse_gamma_gaussian(
        x, μ!.ν, μ!.Λ, μ!.γ, μ!.σ2!.α, μ!.σ2!.β);
  }

  function pdf(x:Real[_]) -> Real {
    return pdf_multivariate_normal_inverse_gamma_gaussian(x,
        solve(μ!.Λ, μ!.ν), μ!.Λ, μ!.σ2!.α, μ!.σ2!.β);
  }
