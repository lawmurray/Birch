...
function DelayAffineNormalInverseGammaLogGaussian(x:Random<Real>, a:Real,
    μ:DelayNormalInverseGamma, c:Real) ->
    DelayAffineNormalInverseGammaLogGaussian {
  m:DelayAffineNormalInverseGammaLogGaussian(x, a, μ, c);
  return m;
}
