...
program test(N:Integer <- 10000) {
  ...
  code <- code + run_test("chain_gaussian_gaussian", N);
  ...
  code <- code + run_test("chain_multivariate_gaussian_gaussian", N);
  ...
  code <- code + run_test("identical_inverse_gamma_gaussian", N);
  code <- code + run_test("identical_normal_inverse_gamma_gaussian", N);
  code <- code + run_test("dot_identical_normal_inverse_gamma_gaussian", N);
  code <- code + run_test("dot_identical_normal_inverse_gamma_log_gaussian", N);
  code <- code + run_test("linear_identical_normal_inverse_gamma_gaussian", N);
