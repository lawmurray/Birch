...
program test(N:Integer <- 10000) {
  ...
  code <- code + run_test("negative_scaled_gamma_exponential", N);
  code <- code + run_test("negative_scaled_gamma_poisson", N);
  ...
  code <- code + run_test("pdf_linear_multivariate_normal_inverse_gamma_multivariate_gaussian", N);
  code <- code + run_test("pdf_matrix_gaussian", N);
  code <- code + run_test("pdf_matrix_normal_inverse_gamma", N);
  code <- code + run_test("pdf_matrix_normal_inverse_gamma_matrix_gaussian", N);
  code <- code + run_test("pdf_matrix_normal_inverse_wishart", N);
  code <- code + run_test("pdf_matrix_normal_inverse_wishart_matrix_gaussian", N);
  code <- code + run_test("pdf_multivariate_gaussian", N);
  code <- code + run_test("pdf_multivariate_gaussian_multivariate_gaussian", N);
  code <- code + run_test("pdf_multivariate_inverse_gamma", N);
  code <- code + run_test("pdf_multivariate_normal_inverse_gamma_multivariate_gaussian", N);
  code <- code + run_test("pdf_multivariate_uniform", N);
  code <- code + run_test("pdf_uniform_int", N);
  ...
  code <- code + run_test("cdf_gamma_poisson", N);
  code <- code + run_test("cdf_gaussian", N);
  code <- code + run_test("cdf_geometric", N);
