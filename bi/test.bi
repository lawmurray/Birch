...
program test(N:Integer <- 10000) {
  ...
  code <- code + run_test("cdf_gamma_exponential");
  ...
  code <- code + run_test("cdf_inverse_gamma_gamma");
  code <- code + run_test("cdf_linear_normal_inverse_gamma_gaussian");
  code <- code + run_test("cdf_negative_binomial");
  code <- code + run_test("cdf_normal_inverse_gamma");
  code <- code + run_test("cdf_normal_inverse_gamma_gaussian");
  ...
  code <- code + run_test("pdf_linear_matrix_normal_inverse_wishart_matrix_gaussian");
  ...
  code <- code + run_test("pdf_uniform_int");
