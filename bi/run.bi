...
program run() {
  ...
  code <- code + system("birch sample --config config/simulate.json --input input/simulate.json --output output/simulate.json");
  ...
  code <- code + system("birch sample --config config/filter.json --input input/filter.json --output output/filter.json");
