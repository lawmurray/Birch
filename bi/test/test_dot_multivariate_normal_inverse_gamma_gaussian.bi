 ...
 */
program test_dot_multivariate_normal_inverse_gamma_gaussian(N:Integer <- 10000) {
  X1:Real[N,7];
  X2:Real[N,7];
  ...
  for i:Integer in 1..N {
    m:TestDotMultivariateNormalInverseGammaGaussian(a, μ, Σ, c, α, β);
    m.play();
    X1[i,1..7] <- m.forward();
  }
...
class TestDotMultivariateNormalInverseGammaGaussian(a:Real[_],
