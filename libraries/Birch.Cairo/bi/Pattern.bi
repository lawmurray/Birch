...
class Pattern {
  ...
  function addColorStopRGB(offset:Real, red:Real, green:Real, blue:Real) {
    cpp{{
    cairo_pattern_add_color_stop_rgb(this_()->pattern, offset, red, green, blue);
    }}
  }
  ...
  function addColorStopRGBA(offset:Real, red:Real, green:Real, blue:Real,
      alpha:Real) {
    cpp{{
    cairo_pattern_add_color_stop_rgba(this_()->pattern, offset, red, green, blue,
        alpha);
    }}
  }
  ...
  function destroy() {
    cpp{{
    cairo_pattern_destroy(this_()->pattern);
    }}
  }
}
