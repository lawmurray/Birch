 ...
 * @file
 */
#include "src/visitor/Transformer.hpp"

#include "src/visitor/all.hpp"

birch::Expression* birch::Transformer::modify(Spin* o) {
...
birch::Statement* birch::Transformer::modify(Assume* o) {
  Cloner cloner;
...
birch::Statement* birch::Transformer::modify(Class* o) {
...
birch::Statement* birch::Transformer::modify(Fiber* o) {
  ContextualModifier::modify(o);
  createStart(o);
  createResumes(o);
  return o;
...
birch::Statement* birch::Transformer::modify(MemberFiber* o) {
  ContextualModifier::modify(o);
  createStart(o);
  createResumes(o);
  return o;
...
void birch::Transformer::insertReturn(Statement* o) {
...
void birch::Transformer::createStart(Fiber* o) {
  Resumer resumer;
  o->start = o->accept(&resumer)->accept(this);
  insertReturn(o->start);
}

void birch::Transformer::createResumes(Fiber* o) {
