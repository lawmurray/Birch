 ...
 * @file
 */
#include "src/visitor/Resumer.hpp"

birch::Resumer::Resumer(const Yield* yield) :
    yield(yield),
    foundYield(yield == nullptr) {
  //
}

birch::Resumer::~Resumer() {
  //
}

birch::Statement* birch::Resumer::clone(const Fiber* o) {
...
birch::Statement* birch::Resumer::clone(const MemberFiber* o) {
...
birch::Statement* birch::Resumer::clone(const LocalVariable* o) {
...
birch::Statement* birch::Resumer::clone(const Yield* o) {
...
birch::Statement* birch::Resumer::clone(const Return* o) {
  if (foundYield) {
...
birch::Statement* birch::Resumer::clone(const ExpressionStatement* o) {
  if (foundYield) {
    return Cloner::clone(o);
  } else {
    return new EmptyStatement(o->loc);
...
birch::Statement* birch::Resumer::clone(const Assert* o) {
  if (foundYield) {
    return Cloner::clone(o);
  } else {
    return new EmptyStatement(o->loc);
...
birch::Statement* birch::Resumer::clone(const Raw* o) {
  if (foundYield) {
    return Cloner::clone(o);
  } else {
    return new EmptyStatement(o->loc);
...
birch::Statement* birch::Resumer::clone(const StatementList* o) {
...
birch::Statement* birch::Resumer::clone(const If* o) {
...
birch::Statement* birch::Resumer::clone(const For* o) {
...
birch::Statement* birch::Resumer::clone(const Parallel* o) {
...
birch::Statement* birch::Resumer::clone(const While* o) {
  auto cond = o->cond->accept(this);
  auto foundBefore = foundYield;
  auto braces = o->braces->accept(this);
  auto foundAfter = foundYield;
...
birch::Statement* birch::Resumer::clone(const DoWhile* o) {
  auto foundBefore = foundYield;
  auto braces = o->braces->accept(this);
  auto cond = o->cond->accept(this);
  auto foundAfter = foundYield;
...
birch::Statement* birch::Resumer::clone(const Block* o) {
  auto braces = o->braces->accept(this);
  if (foundYield) {
