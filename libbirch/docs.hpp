 ...
 * [Eigen](https://eigen.tuxfamily.org/) integration, functionality such
 * as dynamic memory management (pooled allocators, reference counting,
 * cycle collection, lazy deep copy). This is particularly important
 * for memory efficiency in PPLs using Sequential Monte Carlo (SMC) and
 * related methods for inference.
 *
 * LibBirch supports C++ code generated by the compiler for
 * [Birch](https://birch-lang.org), a probabilistic programming
 * language.
 *
 * ## Reference counting
 *
