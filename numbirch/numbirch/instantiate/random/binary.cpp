...
#define RANDOM_BINARY_SECOND(f, R, T, U) \
    ...
    RANDOM_BINARY_SIG(f, R, ARRAY(T, 2), ARRAY(U, 0)) \
    RANDOM_BINARY_SIG(f, R, ARRAY(T, 0), ARRAY(U, 2)) \
    RANDOM_BINARY_SIG(f, R, ARRAY(T, 2), U) \
    RANDOM_BINARY_SIG(f, R, T, ARRAY(U, 2)) \
    RANDOM_BINARY_SIG(f, R, ARRAY(T, 1), ARRAY(U, 0)) \
    RANDOM_BINARY_SIG(f, R, ARRAY(T, 0), ARRAY(U, 1)) \
    RANDOM_BINARY_SIG(f, R, ARRAY(T, 1), U) \
    RANDOM_BINARY_SIG(f, R, T, ARRAY(U, 1))
